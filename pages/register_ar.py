...
paper_file = st.file_uploader("تحميل المقال (ملف PDF أو DOCX أو DOC، 100-150 كلمة)", type=["pdf", "docx", "doc"])
...
if st.button("التسجيل"):
    if email != confirm_email:
        ...
        with st.spinner("تحميل معلوماتك..."):
            ...
            # Send email
            # if send_email("hssaiudl@gmail.com", "تسجيل جديد في الملتقى", email_body, paper_file):
            ...
            if send_email("hssaiudl@gmail.com", "New Conference Registration", email_body, paper_file):
                ...
                إذا كانت لديك أي أسئلة أو تحتاج إلى إجراء أي تغييرات، فلا تتردد في الاتصال بنا مباشرة على hssaiudl@gmail.com أو عبر الهاتف على +213 668 11 31 31.
                """)
                body = f"""
                عزيزي {full_name}،

                شكرًا لتقديم معلوماتك والمقال الخاص بك لـ {translate('page_title')} المقرر عقده في 26-27 فبراير 2025 في جامعة جيلالي ليابس، سيدي بلعباس. نحن متحمسون لمشاركتك في هذا الحدث!
                ...
                إذا كانت لديك أي أسئلة أو تحتاج إلى مزيد من المعلومات، فلا تتردد في التواصل معنا على hssaiudl@gmail.com أو +213 668 11 31 31.
                ...
                """
                time.sleep(10)
                send_email(email, "تأكيد تقديم مشاركتك في الملتقى", body)
        ...
        st.error("يرجى ملء جميع الحقول وتحميل المقال الخاص بك.")
