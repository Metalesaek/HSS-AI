...
- **الرئيس الشرفي للملتقى**: أ.د/ بوزياني مراحي / مدير جامعة جيلالي ليابس (سيدي بلعباس)
- **المشرف العام على الملتقى**:أ.د/ الأحمر قادة / عميد كلية العلوم الإنسانية والاجتماعية
- **المنسق العام للملتقى**:	 د. مراح سعيد
- **رئيس الملتقى**:	د.مطاليس عائشة
- **رئيس اللجنة العلمية**:	 د. لحاج أحمد كريمة
- **رئيس اللجنة التنظيمية**:	د.عمر أوسامة
- **التاريخ المبرمج لانعقاد الملتقى**:	26-27فبراير 2025
